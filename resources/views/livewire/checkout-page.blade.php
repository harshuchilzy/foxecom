                                ...
                                <div class="flex flex-col gap-3">
                                    <div class="w-full relative" x-show="!showAddressEdit">
                                        <x-wui-select wire:model.live="selectedShippingAddress"
                                            ...
                                            :async-data="route('api.address.search')" option-label="address" option-value="id" />
                                        <ul class="flex text-sm font-medium text-center w-full" id="delivery-option-tab"
                                            data-tabs-toggle="#delivery-option-tab-content"
                                            ...
                                            <li class="me-2 w-full" role="presentation">
                                                <button
                                                    ...
                                                    data-tabs-target="#style-shipping-address" type="button"
                                                    ...
                                                    <span
                                                        class="text-[#111111] font-normal text-[16px]">Delivery</span>
                                                </button>
                                            </li>
                                            <li class="me-2 w-full" role="presentation">
                                                <button
                                            ...
                                            <form wire:submit="save" class="flex flex-col gap-3">
                                                ...
                                                <div x-show="!showAddressEdit">
                                                    <button type="button" x-on:click="showAddressEdit = true"
                                                        class="text-[#111111] font-normal text-[13px] underline">Enter
                                                        address
                                                        manually</button>
                                                </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="pt-5">
                                ...
                                <div class="flex gap-5 items-center justify-start">
                                    ...
                                    <div>
                                        <h2 class="font-semibold text-[16px] text-black">Tick Tock 8K Magic - Lemon &
                                            Lime
                                            (Try
                                            For Free)</h2>
