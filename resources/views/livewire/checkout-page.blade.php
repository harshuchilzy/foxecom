        ...
        <div class="w-full lg:w-[60%] flex flex-col gap-3">
            <div>
                <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white text-gray-900"
                    ...
                    <div id="accordion-flush-body-1" class="{{ $currentStep != 1 ? 'hidden' : ''}}"
                        ...
                        <div class="py-5 border-b border-gray-200">
                            ...
                            <div class="py-5">
                                ...
                                <p class="font-semibold text-[16px] text-[#70707C]">{{$shipping['first_name'] . ' ' .
                                    $shipping['last_name']}}</p>
                                <p class="font-semibold text-[16px] text-[#70707C]">{{$shipping['company_name']}}</p>
                                <p class="font-semibold text-[16px] text-[#70707C]">{{$shipping['line_one']}}
                                    {{$shipping['line_two']}}</p>
                            ...
                            <div class="py-5" delivery x-data="{showAddressEdit: false}">
                                <div class="flex flex-col gap-3">
                                    <div class="w-full relative" x-show="!showAddressEdit">
                                        <x-wui-select wire:model.live="selectedShippingAddress"
                                            label="Search an address" placeholder="Select shipping address"
                                ...
                                <form wire:submit="save" class="flex flex-col gap-3">
                                    ...
                                    <div x-show="!showAddressEdit">
                                        <button type="button" x-on:click="showAddressEdit = true"
                                            class="text-[#111111] font-normal text-[13px] underline">Enter address
                                            manually</button>
                                    </div>
                                    ...
                                    {{-- <div class="lg:w-[40%] xl:w-[30%]">
                                        <input type="tel" wire:model.live="{{$type}}.contact_phone"
                                            class="border border-[#000000] bg-white rounded-[6px] w-full py-2 md:py-4"
                                            placeholder="Phone number" />
                                    </div> --}}
                                    {{-- <div class="lg:w-[40%] xl:w-[30%]">
                                        <button
                                            class="w-full bg-[#0066FF] rounded-[30px] h-[60px] text-white text-[16px] font-normal text-center">Save
                                            & Continue</button>
                                    </div> --}}
                                </div>
                            ...
                            <div class="pt-3">
                                ...
                                <div class="flex items-center gap-4 py-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="default-radio-2" class="ms-2 text-sm font-medium text-black">Credit
                                            or Debit Card</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="accordion-flush-body-3" class="{{ $currentStep != 3 ? 'hidden' : ''}}"
                        aria-labelledby="accordion-flush-heading-3">
                        <div class="py-5 border-b border-gray-200">
                            <div class="pt-5">
                                <p class="text-[16px] font-semibold text-[#70707C]">By clicking the 'Submit payment'
                        ...
                        <div class="flex gap-5 items-center justify-start">
                            <div class="">
                                <img class="w-[60px] h-[60px] object-contain"
                                    src="{{ asset('images/tiktokmagic.png') }}" alt="">
                            </div>
                            <div>
                                <h2 class="font-semibold text-[16px] text-black">Tick Tock 8K Magic - Lemon & Lime (Try
                                    For Free)</h2>
