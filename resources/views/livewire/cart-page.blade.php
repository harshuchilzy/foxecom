                            ...
                            <div class="flex flex-row gap-8 border-b border-[#D9D9D9] pb-5">
                                ...
                                <div class="w-2/3 flex flex-col gap-2 justify-between">
                                    ...
                                    <div class="flex flex-row gap-3 items-center mt-auto pb-3">
                                        ...
                                        <div class="border border-[#757575] rounded-[50px] flex flex-row items-center gap-2 px-1 py-1.5 w-[80%] lg:w-[30%]" x-data="{quantity_{{$index}}: $wire.entangle('lines.{{ $index }}.quantity')}">
                                            <button class="px-2 border-0 border-[#757575] cursor-pointer text-3xl" @click="quantity_{{$index}}--">-</button>
                                            <input type="number" value="1" class="w-full text-center flex justify-center border-0 p-0 m-0 nobutton" wire:model.live="lines.{{ $index }}.quantity"/>
                                            <button class="px-2 border-0 border-[#757575] cursor-pointer text-3xl" @click="quantity_{{$index}}++">+</button>
                                        </div>
                                    </div>
                                    <button
