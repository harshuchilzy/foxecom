...
<section>
    <div class="relative bg-white md:hidden">
        <div x-data="{
             ...
             class="flex gap-4 lg:gap-5 items-center w-full md:w-1/2 flex-col-reverse lg:flex-row bg-[#0B0E2D] pb-8"
             style="border-bottom-left-radius: 100% 25%; border-bottom-right-radius: 100% 25%;">
            ...
            <div class="w-full md:w-1/2">
                ...
                <div class="md:hidden flex items-center justify-between px-4">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        <div>
                            <svg width="89" height="18" viewBox="0 0 89 18" fill="#3B82F6"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M8.74884 2.95918C8.49029 2.51361 7.84683 2.51361 7.58828 2.95918L5.76744 6.09716C5.63972 6.31727 5.41896 6.46747 5.16734 6.50548L1.75496 7.02088C1.18183 7.10744 0.980788 7.83107 1.42714 8.20087L3.96921 10.307C4.20452 10.5019 4.31517 10.8094 4.25801 11.1096L3.59304 14.6017C3.48792 15.1537 4.06743 15.5826 4.56466 15.3208L7.77785 13.629C8.02241 13.5002 8.31471 13.5002 8.55928 13.629L11.7725 15.3208C12.2697 15.5826 12.8492 15.1537 12.7441 14.6017L12.0791 11.1096C12.022 10.8094 12.1326 10.5019 12.3679 10.307L14.91 8.20087C15.3563 7.83108 15.1553 7.10744 14.5822 7.02088L11.1698 6.50548C10.9182 6.46747 10.6974 6.31727 10.5697 6.09716L8.74884 2.95918Z"
                                    fill="#3B82F6"/>
                                <path
                                    d="M26.8504 2.95918C26.5919 2.51361 25.9484 2.51361 25.6898 2.95918L23.869 6.09716C23.7413 6.31727 23.5205 6.46747 23.2689 6.50548L19.8565 7.02088C19.2834 7.10744 19.0824 7.83107 19.5287 8.20087L22.0708 10.307C22.3061 10.5019 22.4167 10.8094 22.3596 11.1096L21.6946 14.6017C21.5895 15.1537 22.169 15.5826 22.6662 15.3208L25.8794 13.629C26.124 13.5002 26.4163 13.5002 26.6608 13.629L29.874 15.3208C30.3713 15.5826 30.9508 15.1537 30.8456 14.6017L30.1807 11.1096C30.1235 10.8094 30.2342 10.5019 30.4695 10.307L33.0115 8.20087C33.4579 7.83108 33.2569 7.10744 32.6837 7.02088L29.2713 6.50548C29.0197 6.46747 28.799 6.31727 28.6712 6.09716L26.8504 2.95918Z"
                                    fill="#3B82F6"/>
                                <path
                ...
                <div class="md:hidden flex w-full">
                    <div id="short-description-accordion-flush" data-accordion="collapse"
                         ...
                         data-inactive-classes="text-gray-500 w-full">
                        <h2 id="short-description-accordion-flush-heading-1 w-full">
                            <button type="button"
                                    ...
                                    data-accordion-target="#short-description-accordion" aria-expanded="true"
                                    aria-controls="short-description-accordion">
                ...
                <div class="md:flex items-center gap-4 mb-8 border-b-2 border-black pb-4 hidden">
                    <div class="flex items-baseline gap-5 border-r border-black pr-3">
                        <x-product-price class="font-medium flex items-baseline flex-wrap gap-4"
                                         :variant="$this->variant"/>
                    </div>
                    <div class="flex items-center gap-2 flex-wrap">
                        <div>
                            <svg width="89" height="18" viewBox="0 0 89 18" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M8.74884 2.95918C8.49029 2.51361 7.84683 2.51361 7.58828 2.95918L5.76744 6.09716C5.63972 6.31727 5.41896 6.46747 5.16734 6.50548L1.75496 7.02088C1.18183 7.10744 0.980788 7.83107 1.42714 8.20087L3.96921 10.307C4.20452 10.5019 4.31517 10.8094 4.25801 11.1096L3.59304 14.6017C3.48792 15.1537 4.06743 15.5826 4.56466 15.3208L7.77785 13.629C8.02241 13.5002 8.31471 13.5002 8.55928 13.629L11.7725 15.3208C12.2697 15.5826 12.8492 15.1537 12.7441 14.6017L12.0791 11.1096C12.022 10.8094 12.1326 10.5019 12.3679 10.307L14.91 8.20087C15.3563 7.83108 15.1553 7.10744 14.5822 7.02088L11.1698 6.50548C10.9182 6.46747 10.6974 6.31727 10.5697 6.09716L8.74884 2.95918Z"
                                    fill="black"/>
                    ...
                    @if ($discountId)
                        <div class="md:max-w-[90%] mt-5">
                            <form wire:submit.prevent="claimOffer">
                                <button
                                    class="bg-white px-[24px] py-[16px] rounded-[100px] text-[#282828] text-center text-[18px] font-bold w-full border border-[#282828] cursor-pointer font-inter">
                                    Claim Offer Now
                                </button>
                            </form>
                        </div>
    ...
    <div class="max-w-[1440px] mx-auto px-4 py-12 border-t mt-10">
        ...
        <form wire:submit.prevent="submitReview" class="space-y-4 max-w-xl">
            <div>
                ...
                <input type="text" id="reviewer_name" wire:model.lazy="reviewForm.name"
            ...
            <div>
                ...
                <input type="email" id="reviewer_email" wire:model.lazy="reviewForm.email"
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
                ...
                <input type="number" min="1" max="5" id="rating" wire:model.lazy="reviewForm.rating"
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
                ...
                <textarea id="review" rows="4" wire:model.lazy="reviewForm.review"
            ...
            <div>
                ...
                <input type="file" id="review_images" wire:model="reviewForm.images" multiple accept="image/*"
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
