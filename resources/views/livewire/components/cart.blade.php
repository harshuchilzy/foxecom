<div class="sm:relative">
    <div x-data="{ linesVisible: $wire.entangle('linesVisible'), count: $wire.entangle('cart_count').live  }">
        <button
            class="grid w-16 h-16 transition border-l border-gray-100 lg:border-l-transparent hover:opacity-75 cursor-pointer"
            ...
            <span class="place-self-center relative">
                ...
                <span class="absolute top-[20%] right-[35%] text-[15px] font-bold text-[#D8AC27]" x-text="count"></span>
            </span>
        </button>
                                        ...
                                        <div class="flex py-4" wire:key="line_{{ $line['id'] }}">
                                            ...
                                            <div class="flex-1 ml-4">
                                                ...
                                                <div class="flex items-center mt-2">
                                                    ...
                                                    @else
                                                        <span class="inline-flex items-center px-3 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-md">
                                                            {{ $line['quantity'] }} FREE
                                                        </span>
                                                    @endif
                                                    ...
                                                    {{-- Only show the trash button on paid lines --}}
                                                    @if (empty($line['meta']['free']))
                                                        <button
