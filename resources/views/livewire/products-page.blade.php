<div>
    ...
    <div class="bg-[#D9D9D97D] py-8">
        ...
        <div class="max-w-[1280px] relative mx-auto" x-data="{show: false}">
            ...
            <div class="pt-6 w-full flex justify-center items-center gap-5" x-show="show" x-cloak>
                {{-- <div>
                ...
                <div>
                    <form class="max-w-sm mx-auto relative">
                        ...
                        <select id="sort_select" wire:model.live="sortOption" class="block py-2 w-full text-sm text-[#000000] font-semibold text-[18px] px-12 border border-[#008ECC] rounded-[30px] bg-white appearance-none focus:outline-none focus:ring-0 peer">
