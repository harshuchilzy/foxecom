                    ...
                    @forelse ($shippingAddresses as $address)
                        ...
                        <tr class="odd:bg-white even:bg-gray-50 border-gray-200">
                            ...
                            <td class="text-center">
                               <button class="p-2 ml-auto text-gray-600 transition-colors rounded-lg hover:bg-gray-100 hover:text-red-700 cursor-pointer" type="button" wire:click="dropShippingAddress({{ $address->id }})">
