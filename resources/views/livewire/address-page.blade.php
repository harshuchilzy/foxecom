                        ...
                        <div class="relative p-4 w-full max-w-2xl max-h-full">
                            <div class="relative bg-white rounded-lg shadow-sm ">
                                ...
                                <form wire:submit.prevent="saveShippingAddress" novalidate>
                                    ...
                                    <div class="flex justify-end items-center p-4 md:p-5 border-t border-gray-200 rounded-b ">
                                        <button
                                        {{-- data-modal-hide="shipping-address-edit" --}}
                                        type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Save</button>
                                        <button
                                        {{-- data-modal-hide="shipping-address-edit" --}}
