    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 w-full">
        <div class="flex flex-col gap-8">
            <div class="flex justify-between w-full">
                ...
                @if ($billingAddress)
                    <button class="cursor-pointer" wire:click="billingAddressEditDialog" type="button">
            ...
            <div class="border border-[#008ECC] rounded-[6px] p-5 flex flex-col gap-4 items-start justify-start">
                ...
                <x-wui-dialog id="billingAddressEdit" title="Billing Address" description="">
                    <input type="hidden" name="billing_default" value="1">
                    <div class="mb-6">
                        <label for="company" class="block mb-2 text-sm font-medium text-gray-900 ">Company</label>
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        <div class="relative bg-white rounded-lg shadow-sm ">
                            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t  border-gray-200">
                                ...
                                onclick="window.dispatchEvent(new CustomEvent('close-shipping-modal'))">
                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                    </svg>
                                    <span class="sr-only">Close modal</span>
                            ...
                            <form wire:submit.prevent="saveShippingAddress" novalidate>
                                ...
                                <div class="flex justify-end items-center p-4 md:p-5 border-t border-gray-200 rounded-b ">
                                    <button onclick="window.dispatchEvent(new CustomEvent('close-shipping-modal'))" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Save</button>
                                    <button type="button"
                                        onclick="window.dispatchEvent(new CustomEvent('close-shipping-modal'))"
