                            ...
                            <div class="swiper-wrapper">
                                @foreach ($discounts as $discount)
                                    @php
                                        ...
                                        $productUrl = $this->getProductUrl($discount);
                                    @endphp
                    ...
                    <div class="grid grid-cols-2 gap-3 lg:gap-6">
                        @foreach ($discountChunk as $discount)
                            ...
                            <div class="relative w-full h-[260px] lg:h-[500px] bg-[linear-gradient(180deg,_rgba(73,77,94,0.08)_0%,_#FFFFFF_100%)] rounded-2xl p-3 lg:p-6 lg:pb-6 pb-0 shadow-[0px_10px_25px_0px_#00000073] hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden flex flex-col justify-between">
                                ...
                                @if ($productUrl)
                                    <a href="{{ route('product.view', ['slug' => $productUrl]) }}?discount={{ $discount->id }}" class="group lg:flex items-center gap-2 text-gray-800 font-medium hover:text-gray-900 transition-colors duration-200 hidden z-9 lg:text-[22px]">
                                        @if ($claimed > 0)
                                ...
                                @if ($productUrl)
                                    <a href="{{ route('product.view', ['slug' => $productUrl]) }}?discount={{ $discount->id }}" class="absolute top-4 right-4 p-3 bg-[linear-gradient(180deg,_rgba(73,77,94,0.9)_0%,_rgba(0,0,0,0.8)_100%)] rounded-full lg:flex items-center justify-center hidden z-2">
