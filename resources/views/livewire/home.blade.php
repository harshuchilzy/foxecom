    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex w-full flex-col bg-[#FFFFFF]">
            ...
            @else
                <div class="hero-section-gif w-full relative">
                    ...
                    <div class="absolute bottom-[120px] right-[20px]  z-10">
                        <a class="bg-themeblue rounded-[45px] text-white px-6 py-2 bottom-8 right-8 hidden lg:block"
                           href="{{ $metaFields['redeem-offer-link'] ?? '#' }}">Redeem Free Offer</a>
                    </div>
            ...
            <div class="flex flex-col bg-[#FFF]">
                ...
                <span
                    class="font-bold text-black">{{$metaFields['promotion-section-bold-title'] ?? 'Promotion Spotlight.'}}</span>
                        <span
                            class="font-semibold text-[#6E6E73] italic">{{$metaFields['promotion-section-title'] ?? 'Our monthly offer selection for you.'}}</span>
                    </h2>
            ...
            <div class="bg-white px-4 lg:px-8 xl:px-16 py-12 max-w-[1440px] mx-auto w-full">
                ...
                <span
                    class="font-bold text-black">{{$metaFields['latest-promotion-bold-title'] ?? 'The latest promotions.'}}</span>
                        <span
                            class="font-semibold text-[#6E6E73] italic">{{$metaFields['latest-promotion-title'] ?? 'Take a look what’s new.'}}</span>
                    </h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @foreach ($latestDiscounts as $discount)
                        ...
                        <div class="rounded-[20px] p-4 lg:p-8 {{ $cardBg }} shadow-[0px_4px_4px_0px_#00000040] w-full">
                            ...
                            <p class="text-[15px] font-semibold bg-gradient-to-r from-[#2A86F8] via-[#E64889] to-[#F4530C] text-transparent bg-clip-text mt-2">
                                Claim Your Free Outer Here</p>
                            ...
                            <div class="w-full flex justify-center items-center mt-4 lg:mt-8 xl:mt-0">
                                <img class="w-[180px] lg:w-[200px] xl:w-[350px] xl:h-[240px] object-contain"
                                     src="{{ $image }}"
                                     alt="{{ $title }}">
                            </div>
            ...
            <div class="bg-white px-4 lg:px-8 xl:px-16 py-6 xl:py-12 max-w-[1440px] mx-auto w-full">
                <div class="flex w-full justify-start pb-5">
                    <h2 class="text-left text-[16px] lg:text-[28px]">
                        ...
                        <span
                            class="font-semibold text-[#6E6E73] italic">{{$metaFields['offers-title'] ?? 'Click to reveal.'}}</span>
                    </h2>
                </div>
                        ...
                        @foreach ($discountChunk as $discount)
                            ...
                            <div
                                ...
                                <div class="mb-4 hidden lg:block">
                                    <div class="mb-4">
                                        <img class="w-[140px] mb-2" src="{{ asset('images/tikcktocklogo.png') }}"
                                             alt="Tick Tock Logo">
                                ...
                                <a href="{{ route('discount.show', ['id' => $discount->id]) }}"
                                   class="group lg:flex items-center gap-2 text-gray-800 font-medium hover:text-gray-900 transition-colors duration-200 hidden z-9">
                                    <span class="text-themeblue">Reveal Offer</span>
                                    <span
                                        class="text-lg group-hover:translate-x-1 transition-transform duration-200 text-themeblue">→</span>
                                </a>
                                ...
                                <div
                                    class="absolute top-4 right-4 p-3 bg-gray-600 rounded-full lg:flex items-center justify-center hidden">
                                    <svg width="32" height="31" viewBox="0 0 32 31" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M2.36084 18.4702C3.18896 18.4704 3.86059 19.1421 3.86084 19.9702V27.2749H11.4634C12.2915 27.2751 12.9631 27.9468 12.9634 28.7749C12.9634 29.6032 12.2916 30.2747 11.4634 30.2749H3.36084C1.98029 30.2747 0.86084 29.1555 0.86084 27.7749V19.9702C0.861089 19.1421 1.53273 18.4704 2.36084 18.4702ZM20.5962 8.23096C22.253 8.23097 23.5962 9.57411 23.5962 11.231V19.9058C23.596 21.5624 22.2529 22.9057 20.5962 22.9058H11.4263C9.76956 22.9058 8.4265 21.5624 8.42627 19.9058V11.231C8.42627 9.5741 9.76941 8.23096 11.4263 8.23096H20.5962ZM28.6655 0.86084C30.0461 0.861027 31.1655 1.98024 31.1655 3.36084V11.1655C31.1655 11.9938 30.4938 12.6653 29.6655 12.6655C28.8373 12.6653 28.1655 11.9938 28.1655 11.1655V3.86084H20.563C19.7347 3.86065 19.063 3.18915 19.063 2.36084C19.063 1.53253 19.7347 0.861034 20.563 0.86084H28.6655Z"
                                            fill="url(#paint0_linear_754_1551)"/>
                                        <defs>
                                            <linearGradient id="paint0_linear_754_1551" x1="15.3352" y1="0.86084"
                                                            x2="15.3352"
                                                            y2="28.9993" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="white"/>
                                                <stop offset="1" stop-color="white" stop-opacity="0.7"/>
                                            </linearGradient>
                                        </defs>
                    ...
                    @if ($index == 0)
                        <div class="w-full my-12">
                            <a href="{{ route('products.index') }}">
                                <img class="w-full h-full rounded-[14px]" src="{{ asset('images/TT-BANNER.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    @elseif ($index == 1)
                        <div class="w-full my-12">
                            <a href="{{ route('products.index') }}">
                                <img class="w-full h-full rounded-[14px]" src="{{ asset('images/AF-BANNER.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    @endif
