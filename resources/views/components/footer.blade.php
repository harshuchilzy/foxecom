<footer class="w-full">
    <div class="flex justify-between items-start px-5 max-w-[1440px] mx-auto py-10 w-full">
        <div>
            <img class="w-[100px]" src="{{ asset('images/blacklogo.png') }}" alt="Footer Logo">
        </div>
        ...
        <div>
            <button class="bg-[#1B1819] text-white py-[8px] px-[16px] rounded-lg">Request a call</button>
            <div class="mt-4">
                <p class="font-semibold text-[14px] text-[#1B1819]">+1 (999) 999-99-99</p>
                <p class="font-semibold text-[14px] text-[#1B1819]">info@logoipsum.com</p>
            </div>
        </div>
    </div>
