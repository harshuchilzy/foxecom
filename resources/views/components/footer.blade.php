<footer class="w-full bg-white">
    <div
        class="flex justify-between items-start px-5 max-w-[1280px] mx-auto py-10 w-full flex-col md:flex-row gap-[30px] md:gap-0">
        <div>
            <a href="{{route('home')}}"><img class="w-[100px]" src="{{ asset('images/blacklogo.png') }}"
                                             alt="Footer Logo"></a>
        </div>
        ...
        <div class="flex flex-col items-center lg:items-start">
            ...
            <div class="mt-4">
                ...
                <a href="mailto:accounts@foxergo.com">
                    <p class="font-semibold text-[14px] text-[#1B1819]">
                        accounts@foxergo.com
                    </p>
                </a>
            </div>
        </div>
