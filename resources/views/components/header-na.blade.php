    ...
    <div class="lg:flex items-center container mx-auto gap-8 hidden p-4">
        ...
        <div class="flex items-center justify-between gap-4 w-full">
            ...
            <div class="flex items-center gap-4 flex-wrap xl:flex-nowrap lg:w-[20%] xl:w-auto">
                <a href="{{route('offers')}}" class="w-[150px] h-[40px] flex items-center justify-center gap-2 rounded-[60px] hover:bg-[#1275EE] {{ request()->routeIs('offers') ? 'bg-[#1275EE]' : 'bg-[#1275EE4D]' }}">
                    <span>
                ...
                <a href="" class="w-[150px] h-[40px] flex items-center justify-center gap-2 rounded-[60px] hover:bg-[#1275EE] {{ request()->routeIs('products.index') ? 'bg-[#1275EE]' : 'bg-[#1275EE4D]' }}">
                    <span>
