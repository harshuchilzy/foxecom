    ...
    <div class="lg:flex items-center container mx-auto gap-8 hidden p-4">
        ...
        <div class="flex items-center justify-between gap-4 w-full">
            ...
            <div class="flex items-center gap-4 flex-wrap xl:flex-nowrap lg:w-[20%] xl:w-auto">
                <a href="{{route('home')}}" class="w-[150px] h-[40px] flex items-center justify-center gap-2 rounded-[60px] {{ request()->routeIs('home') ? 'bg-[#1275EE4D]' : 'bg-[#1275EE]' }}">
                    <span>
                ...
                <a href="{{route('wholesale')}}" class="w-[150px] h-[40px] flex items-center justify-center gap-2 rounded-[60px] {{ request()->routeIs('wholesale') ? 'bg-[#1275EE4D]' : 'bg-[#1275EE]' }}">
                    <span>
