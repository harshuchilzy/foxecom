...
class OrderStatsOverviewExtension extends OrderStatsOverview
{
    ...
    //     )->whereNotIn('status', ['payment-offline', 'awaiting-payment'])->first()->sub_total;
    ...
    // {
    //     $currentCount = $currentDate->whereNotIn('status', ['payment-offline', 'awaiting-payment'])->count();
    //     $previousCount = $previousDate->whereNotIn('status', ['payment-offline', 'awaiting-payment'])->count();
